...
const AssignmentResult = lazy(() => import("../pages/students/AssignmentResult"));
    ...
    <BrowserRouter>
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          {/* ── Catch-all 404 ──────────────────────────────────────────
              Must stay LAST. Renders a noindex 404 page for any unmatched
              URL instead of a blank page, preventing soft-404 / broken-URL
