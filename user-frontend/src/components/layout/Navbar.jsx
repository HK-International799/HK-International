      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <ul className="hidden md:flex items-center gap-8 lg:gap-10">
            {/* ── Logged-out only: Home, Courses, Blog, About ─────────────── */}
            {!isAuthenticated && (
              <>
...
${coursesOpen ? "scale-105" : "hover:scale-105"}`}
            ...
            {/* ── Always visible: Contact, Payments ───────────────────────── */}
            <motion.li whileHover={{ y: -4 }}>
              <NavLink
                to="/contact"
            ...
            {!isAuthenticated && (
              <motion.li whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  ...
                  aria-label="Register"
                  className="relative border-2 border-indigo-600 text-indigo-600 px-4 py-[7px] rounded-xl hover:rounded-full hover:bg-indigo-600 hover:text-white transition-all ease-in-out font-semibold text-[15px]"
                >
                  Register
                </Link>
              </motion.li>
          ...
          {isOpen && (
            ...
            >
              <ul className="flex flex-col gap-5 font-medium text-lg">
                {/* ── Logged-out only: Home, Courses accordion, Blog, About ── */}
                {!isAuthenticated && (
                  <>
                    <li>
                      <Link
                    ...
                    <>
                      <li>
                        <Link
                          ...
                          onClick={() => setIsOpen(false)}
                          aria-label="Register"
                          className="block text-center border-2 border-indigo-600 text-indigo-600 font-semibold px-5 py-2 rounded-lg hover:bg-indigo-600 hover:text-white transition-colors"
                        >
                          Register
                        </Link>
                      </li>
