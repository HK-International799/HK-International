...
//   { to: "/student/exam", label: "Exams", icon: <FaPaperPlane size={18} /> },
...
const navItems = [
  ...
  // { to: "/student/chat",          label: "Chat",           icon: <MessageCircle size={18} />, badge: true },
  // { to: "/student/question-bank", label: "Question Bank",  icon: <HelpCircle size={18} /> },
  // { to: "/student/feedback",      label: "Feedback",       icon: <MessageSquare size={18} /> },
  // { to: "/student/notifications", label: "Notifications",  icon: <Bell size={18} />, badge: true },
