...
//           Read the scenario, then answer the questions based on what you see.
//         </p>
...
//                         className="text-xs bg-amber-50 text-amber-700 border border-amber-200 rounded-md px-3 py-1.5"
//                       >
//                         Resume attempt
//                       </Link>
//                     )}
...
//                       className="inline-flex items-center gap-1 text-sm bg-indigo-600 hover:bg-indigo-700 text-white rounded-md px-3 py-1.5"
//                     >
//                       {mine.length === 0 ? "Start" : "Details"}{" "}
//                       <ArrowRight size={14} />
//                     </Link>
//                   </div>
//                 </div>
...
//             <h2 className="font-medium text-gray-800 mb-2">My Attempts</h2>
...
//                     <td className="py-2">{a.examId?.title || "—"}</td>
//                     <td className="py-2">#{a.attemptNumber}</td>
