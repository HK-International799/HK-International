...
// ====================================================== */
// function QuizPanel({ chapterId, onComplete, onClose, onSuccess }) {
...
//       if (res.passed) {
//         onComplete(); // mark local complete
//         onSuccess?.(); // 🔥 refresh global progress
//       }
//     } catch (err) {
...
// ====================================================== */
// function ChapterContent({ chapter, isCompleted, refreshProgress }) {
...
//     // 🔥 auto collapse after 1s (nice UX)
//     setTimeout(() => {
//       refreshProgress?.();
//     }, 800);
//   };
