...
export default function Register() {
  ...
  return (
    <MainLayout>
      <SEO
        title="Register | Enroll in HSE Courses – 1A HK International"
        description="Create your student account at 1A HK International to enroll in IOSH, OTHM, OSHA, ISO 45001 and CIEH certified health & safety courses."
        keywords={getPageKeywords("register")}
        url="https://hkinternational.uk/register"
      ...
      <div className="relative min-h-screen flex items-center justify-center bg-gray-50 p-6 overflow-hidden">
        ...
        >
          ...
          <p className="text-gray-500 text-center mt-2">
            Start learning globally accredited HSE courses
          </p>
          ...
          <form className="space-y-6 mt-8">
            ...
            <motion.button
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.96 }}
              aria-label="Create 1A HK International student account"
              className="relative w-full bg-gradient-to-r from-indigo-600 to-orange-500 text-white py-3 rounded-lg font-semibold shadow-lg overflow-hidden"
            >
              <span className="relative z-10">Create Account</span>
              <span className="absolute inset-0 bg-white opacity-10 blur-xl animate-pulse"></span>
          ...
          <p className="text-center text-sm text-gray-500 mt-7">
            ...
            <Link
              to="/login"
              title="Login to your 1A HK International student portal"
              className="text-indigo-600 hover:text-indigo-700 font-semibold"
            >
              Login
            </Link>
