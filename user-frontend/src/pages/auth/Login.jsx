  ...
  return (
    <MainLayout>
      <SEO
        ...
        description="Log in to access your 1A HK International courses, certificates, and assignments. Secure student portal for IOSH, OTHM, OSHA, ISO 45001 learners."
        keywords={getPageKeywords("login")}
        url="https://hkinternational.uk/login"
        image="/og-default.png"
        geoRegion="GB"
      />

      <div className="relative min-h-screen grid lg:grid-cols-2 overflow-hidden bg-gradient-to-br from-indigo-800  to-orange-700">
        ...
        <div className="hidden lg:flex relative flex-col justify-center items-center  text-white p-16 overflow-hidden">
          ...
          >
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 text-left">
              <div>
                <h2 className="text-3xl font-bold text-orange-300">10K+</h2>
                <p className="text-sm opacity-80">Students trained globally</p>
              </div>
              <div>
                <h2 className="text-3xl font-bold text-orange-300">40+</h2>
                <p className="text-sm opacity-80">Countries served</p>
              </div>
              <div>
                <h2 className="text-3xl font-bold text-orange-300">20+</h2>
                <p className="text-sm opacity-80">Professional courses</p>
              </div>
              <div>
                <h2 className="text-3xl font-bold text-orange-300">98%</h2>
          ...
          >
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              <div className="relative group">
                ...
                <label
                  htmlFor="login-email"
                  className="absolute left-4 top-2 text-xs text-gray-500 peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-sm peer-placeholder-shown:text-gray-400 transition-all"
                >
                  Email address
                </label>
              </div>
              ...
              <div className="flex justify-between text-sm">
                ...
                <Link
                  to="/forgot-password"
                  title="Reset your 1A HK International password"
              ...
              <motion.button
                type="submit"
                disabled={loading}
                aria-label="Login to 1A HK International student portal"
