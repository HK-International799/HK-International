...
const selfOrFinance = roleMiddleware(["admin", "super_admin", "finance", "student"]);
...
router.put(   "/payments/:id",      financeAccess, upload.single("proof"), updatePayment);
...
router.get("/learner/:userId/course/:courseId/summary", selfOrFinance, getLearnerCourseSummary);
