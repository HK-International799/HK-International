...
export const getMySubmissionService = async (assignmentId, studentId) => {
  ...
  // ✅ FIX: A student who has never submitted an assignment is a normal,
  // expected state — not an error. Returning null (200) instead of
  // throwing 404 lets the assessment page load correctly and show the
  // submission form, rather than being forced to swallow/guess at a
  // 404 as "not submitted yet".
