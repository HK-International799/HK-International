...
//   const [questionGrades, setQuestionGrades] = useState({}); // answerId -> { marks, isCorrect }
//   const [annotations, setAnnotations] = useState({}); // questionId -> icon key
...
//         setDocAnnotations(sub.documentAnnotations || []);
...
//     setAnnotations((prev) => {
//       const updated = { ...prev };
//       if (updated[questionId] === icon) {
//         delete updated[questionId];
//       } else {
//         updated[questionId] = icon;
//       }
//       return updated;
//     });
//   };
...
//         reviewAnnotations,
//         documentAnnotations: docAnnotations, // ✅ ADD THIS
//       });
...
//                                   <Icon
//                                     size={13}
//                                     className={currentIcon === key ? color : ""}
//                                   />
//                                   {label}
//                                 </button>
//                               ),
...
//                 <p className="text-sm">
//                   Student submitted a file — no text answers
//                 </p>
//               </div>
//             )}
//           </div>
...
//                   (() => {
//                     const percentage =
//                       maxMarks > 0 ? (Number(totalScore) / maxMarks) * 100 : 0;
...
//                   <MessageSquare size={16} /> Feedback for student
//                 </label>
//                 <textarea
//                   value={feedback}
