      ...
      <div className="hidden lg:flex w-1/2 items-center justify-center relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-700 to-orange-500">
        ...
        <div className="relative z-10 text-white max-w-md p-10">
          ...
          <p className="text-white/80 leading-relaxed">
            Manage courses, assignments, students, batches and analytics
            with a powerful and intelligent learning management system.
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <p className="text-gray-400 mt-1 mb-6">
              Sign in to continue to LMS Admin Dashboard
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="mt-1 w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 transition"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <input
                    ...
                    placeholder="••••••••"
                    required
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 pr-11"
                  />
